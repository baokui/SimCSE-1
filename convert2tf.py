...
dim = 512
path_export_model,version = '/search/odin/guobk/data/simcse/model/pbmodel/','0'
...
python keras_to_tensorflow.py \
    ...
    --output_model="/search/odin/guobk/data/simcse/model/model_005.pb"
'''
######################################################################################
# 生成pb文件
# 程序开始时声明
sess = tf.Session()
# 读取得到的pb文件加载模型
with gfile.FastGFile("/search/odin/guobk/data/simcse/model/model_005.pb",'rb') as f:
