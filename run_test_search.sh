...
path_models=model_simple,model_simple_distill
...
python -u test_search.py $models $path_models $path_models $path_queries $path_target >> log/simple-distill.log 2>&1 &